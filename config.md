...
```js
{
  ...
  "mongo": {
    ...
    // eg. mongodb://openhim-test.psi-connect.org:27017,openhim-test.psi-connect.org:27018,openhim-test.psi-connect.org:27019/openhim?replicaSet=rs0
    "url": "mongodb://openhim-test.psi-connect.org/openhim",
    // The mongo address for the ATNA auditing to use, if different from the
    // above.
    "atnaUrl": "mongodb://openhim-test.psi-connect.org/openhim"
  },
  "logger": {
    // the logging level
    "level": "info",
  ...
  "router": {
    ...
    "externalHostname": "openhim-test.psi-connect.org"
  ...
  "rerun": {
    ...
    // server)
    "host": "openhim-test.psi-connect.org",
    "processor": {
